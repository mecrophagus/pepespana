...
// Esta sección concentra el mensaje principal, los CTAs
// y la zona visual donde después integraremos el vial real.
  ...
  return (
    ...
    >
      {/* Glow decorativo de fondo.
          Lo usamos para recuperar la atmósfera Dark Biotech
          sin depender todavía de imágenes finales. */}
